...
OUTPUT_DMG="$PROJECT_DIR/dist/Friend-Codex-Router-0.4.0-internal.dmg"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.4.0" "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 7" "$CONTENTS/Info.plist"
