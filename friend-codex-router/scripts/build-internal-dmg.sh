...
OUTPUT_DMG="$PROJECT_DIR/dist/Friend-Codex-Router-0.3.2-internal.dmg"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.2" "$CONTENTS/Info.plist"
